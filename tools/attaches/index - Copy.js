//import Icon from 'https://ianb.ca/example/tools/attaches/svg/toolbox.svg';
...
class AttachesTool {
 ...
 loader:this.api.styles.loader,
  ...
  prepareUploadButton() {
    ...
    this.nodes.button.innerHTML = `./svg/toolbox.svg ${this.config.buttonText}`;//${Icon}
    this.nodes.button.addEventListener('click', this.enableFileUpload2);
