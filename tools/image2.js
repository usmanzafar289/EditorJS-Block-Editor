/**
 * Build stylesrequire('https://ianb.ca/example/tools/index.css').toString();
 */
 


/**
 * Image2 Tool for the Editor.js
 * Works only with pasted image URLs and requires no server-side uploader.
 *
 * @typedef {object} Image2Data
...
class Image2 {
 static get toolbox() {
   ...
   *
   * @param {{data: Image2Data, config: object, api: object}}
  ...
  render() {
    const wrapper = this._make('div', [this.CSS.baseClass, this.CSS.wrapper]),
        ...
        filebrowser = this._make('input', [this.CSS.input, this.CSS.caption], {
...
this.nodes.filebrowser = filebrowser;
    return wrapper;
  }
