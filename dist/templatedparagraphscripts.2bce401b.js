...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js/templatedparagraphscripts.js":[function(require,module,exports) {
...
function msel_clicked(msel) {
  ...
  var selectedvalue;
  if (msel.innerHTML != placeholder) selectedvalue = msel.innerHTML;else selectedvalue = this._placeholder;
...
function choose_person(msel) {
  ...
  if (personData.length > 0) {
    for (var p = 0; p < personData.length; p++) {
      ...
      myOptions[p] = {
        label: personData[p]['fullName'],
        value: personData[p]['id']
      };
    }
  }
...
function choose_vehicle(msel) {
  ...
  if (vehicleData.length > 0) {
    for (var p = 0; p < vehicleData.length; p++) {
      ...
      myOptions[p] = {
        label: vehicleData[p]['vehicleName'],
        value: vehicleData[p]['id']
      };
    }
  }
...
function choose_officer(msel) {
  ...
  if (officerData.length > 0) {
    for (var p = 0; p < officerData.length; p++) {
      ...
      myOptions[p] = {
        label: officerData[p]['fullName'],
        value: officerData[p]['id']
      };
    }
  }
...
function choose_location(msel) {
  ...
  if (locationData.length > 0) {
    for (var p = 0; p < locationData.length; p++) {
      ...
      myOptions[p] = {
        label: locationData[p]['location'],
        value: locationData[p]['id']
      };
    }
  }
...
function hidespan2(deleteable) {
  ...
  deleteable.querySelectorAll('free-text').forEach(function (ele) {
    try {
      ele.setAttribute['contenteditable'] = false; //deletable.querySelectorAll('free-text')[0].setAttribute['contenteditable'] = false

      ele.style.textDecoration = 'none';
      ele.contentEditable = false;
      if (ele.contentEditable == true || ele.contentEditable == "true") ele.style.color = "blue";else ele.style.color = "black";
    } catch (_unused2) {}
  });
  deleteable.querySelectorAll('span m-text deletable-span m-select free-text').forEach(function (ele) {
...
function showspan(deletable) {
  try {
    if (deletable.getAttribute('data-hidden') == true || deletable.getAttribute('data-hidden') == "true") {
      deletable.querySelectorAll('free-text').forEach(function (ele) {
        try {
          ele.setAttribute['contenteditable'] = false; //deletable.querySelectorAll('free-text')[0].setAttribute['contenteditable'] = false
  ...
  for (var i = 0; i < eles.length; i++) {
    ...
    if (ele.tagName === 'deletable-span') {
      try {
        ...
        if (attr.toLowerCase() === 'true' || attr.toLowerCase() === true) {
    ...
    if (ele.tagName.toLowerCase() === 'free-text') {
      ...
      var itemdata = {
        id: ele.id,
        data: ele.toggleButton.textContent
      };
      data.push(itemdata);
    } else if (ele.tagName.toLowerCase() == 'm-time') {
      var itemdata = {
        id: ele.id,
        data: ele.childNodes[0].value
      };
      data.push(itemdata);
      ...
      var itemdata = {
        id: ele.id + idGen.getId(),
        data: ele.innerHTML,
        person_id: selectedOptionId
      };
      data.push(itemdata);
...
var MDateNow = /*#__PURE__*/function (_HTMLElement4) {
  _inherits(MDateNow, _HTMLElement4);

  var _super4 = _createSuper(MDateNow);

  function MDateNow() {
    var _this5;

    _classCallCheck(this, MDateNow);

    _this5 = _super4.call(this); //this.setAttribute("data-hasdata", "false");
    ...
    var today = "<b>" + day + "/" + month + "/" + year + "</b>"; //console.log("today date",today)

    _this5.innerHTML = today;
    return _this5;
  }

  _createClass(MDateNow, [{
    key: "rawvalue",
    value: function rawvalue() {
      if (this.innerHTML == this._placeholder) return "";else return this.innerHTML;
    }
...
var FixedText = /*#__PURE__*/function (_HTMLElement5) {
  _inherits(FixedText, _HTMLElement5);

  var _super5 = _createSuper(FixedText);
...
var ChooseDate = /*#__PURE__*/function (_HTMLElement6) {
  _inherits(ChooseDate, _HTMLElement6);

  var _super6 = _createSuper(ChooseDate);
  ...
  function ChooseDate() {
    ...
    if (_this6.innerHTML.trim() === "") {
      _this6._placeholder = 'Choose Date';
      _this6.innerHTML = "<datetime-picker id='choose_datetime_field' datetime='{{datetime}}' date='{{date}}' default='2021-08-14'></datetime-picker>";
    } else {
...
var ChoosePerson = /*#__PURE__*/function (_HTMLElement7) {
  _inherits(ChoosePerson, _HTMLElement7);

  var _super7 = _createSuper(ChoosePerson);
  ...
  function ChoosePerson() {
    ...
    if (_this7.innerHTML.trim() === "") {
      _this7._placeholder = 'Choose Person';
    ...
    _this7.setAttribute("json-data", JSON.stringify(personData));
...
var ChooseVehicle = /*#__PURE__*/function (_HTMLElement8) {
  _inherits(ChooseVehicle, _HTMLElement8);

  var _super8 = _createSuper(ChooseVehicle);
  ...
  function ChooseVehicle() {
    ...
    if (_this8.innerHTML.trim() === "") {
      _this8._placeholder = 'Choose Vehicle';
    ...
    _this8.setAttribute("json-data", JSON.stringify(vehicleData));
...
var ChooseOfficer = /*#__PURE__*/function (_HTMLElement9) {
  _inherits(ChooseOfficer, _HTMLElement9);

  var _super9 = _createSuper(ChooseOfficer);
  ...
  function ChooseOfficer() {
    ...
    if (_this9.innerHTML.trim() === "") {
      _this9._placeholder = 'Choose Officer';
    ...
    _this9.setAttribute("json-data", JSON.stringify(officerData));
...
var ChooseLocation = /*#__PURE__*/function (_HTMLElement10) {
  _inherits(ChooseLocation, _HTMLElement10);

  var _super10 = _createSuper(ChooseLocation);
  ...
  function ChooseLocation() {
    ...
    _defineProperty(_assertThisInitialized(_this10), "_placeholder", void 0);

    if (_this10.innerHTML.trim() === "") {
      _this10._placeholder = 'Choose Location';
      _this10.innerHTML = _this10._placeholder;
    } else {
      _this10._placeholder = _this10.innerHTML;
    }

    var locationData = getLocationData();

    _this10.setAttribute("json-data", JSON.stringify(locationData));

    _this10.classList.add('chooserbutton');

    _this10.setAttribute("data-hasdata", "false");

    _this10.addEventListener('click', function () {
...
var DeletableSpan = /*#__PURE__*/function (_HTMLElement11) {
  _inherits(DeletableSpan, _HTMLElement11);

  var _super11 = _createSuper(DeletableSpan);
  ...
  function DeletableSpan() {
    ...
    _this11 = _super11.call(this); //           this.contenteditable = false;

    _this11.setAttribute('data-hidden', 'false'); //    let img = document.createElement('img');
...
var Input = /*#__PURE__*/function (_HTMLElement12) {
  _inherits(Input, _HTMLElement12);

  var _super12 = _createSuper(Input);
  ...
  function Input() {
    ...
    _this12 = _super12.call(this); // Attaches a shadow root to our custom element.

    _defineProperty(_assertThisInitialized(_this12), "_placeholder", void 0);
    ...
    inputElement.setAttribute('type', _this12.getAttribute('type'));
...
},{}]},{},["C:/Users/Usman-417/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/templatedparagraphscripts.js"], null)
//# sourceMappingURL=/templatedparagraphscripts.2bce401b.js.map